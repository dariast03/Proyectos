...
const Register = ({ setIsLoggedIn, setUsuarioCompleto }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (response.ok) {
      ...
      if (usuariosResponse.ok) {
        ...
        // Encuentra el usuario con el mismo nombre y correo
  ...
  const checkCompletarPerfil = async (userId) => {
    ...
    if (clientesResponse.ok) {
      ...
      if (cliente) {
        ...
        // Si no hay cliente asociado, redirige a completar perfil
