...
const Listar = () => {
  ...
  useEffect(() => {
    const fetchPedidos = async () => {
      try {
        const pagosResponse = await fetch('https://sj3qgblc-7263.brs.devtunnels.ms/api/Pagos/Listar');
        ...
        const pedidoClientesResponse = await fetch('https://sj3qgblc-7263.brs.devtunnels.ms/api/PedidoClientes/Listar');
