  ...
  useEffect(() => {
    const calcularTotal = () => {
      const total = carrito.reduce((acc, plato) => {
        const precio = plato.isPromotion ? plato.precioConDescuento : plato.precio_Referencia;
  ...
  return (
    <div className="carrito">
      ...
      {carrito.length > 0 ? (
        ...
        <p>Tu carrito está vacío. <Link to="/">¡Añade algunos platos!</Link></p>
      )}
